...
<body>
	<div class="container">
		...
		<section class="content"> <nav> </nav> <main>
		<div id="left">
			<!--------------------------------------------------------- 게임콘트롤영역 + 시간 --------------------------------------------------------->
			<div id="left_timer">
				<div id="show_record">
					<div class="show_nickname">
						...
						님의 최고기록은
						<%=session.getAttribute("bestrecord")%>
						초 입니다.
					</div>
					<p class="show_everyrecord">
						<a href="javascript:ViewLayer();">>>기록보기</a>
					</p>
				</div>
			...
			<div id="left_board2">
				...
				<div class="content">
					<div id=>
						<p class=""><%=session.getAttribute("nickname")%>님의 기록은
							<%=request.getParameter("recentrecord")%>입니다.
						</p>
					</div>
				</div>
			</div>
			...
			<div id="right_chatting">
				...
				<div id="chatboard">
					...
					<div id=sendbox">
						...
						<!-- 송신 버튼 -->
						<button id="sendBtn" type=button value=전소 onclick="sendMessage()" />
					</div>
				</div>
			</div>
		</div>
	...
	<div id="Pop_c"
		style="position: absolute; left: 50; top: 50px; z-index: 1; display: none; width: 950px; height: 207px; background-color: red;">
		보여질 내용</div>
</body>
</html>
